...
<head>
    ...
    <!-- Theme style -->
    <link href="<?php echo $site_url ?>/asset/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo $site_url ?>/asset/css/blue.css" rel="stylesheet" type="text/css" />
...
<!-- iCheck -->
<script src="<?php echo $site_url ?>/asset/js/icheck.min.js" type="text/javascript"></script>
<script>
    $(function () {
        $('input').iCheck({
